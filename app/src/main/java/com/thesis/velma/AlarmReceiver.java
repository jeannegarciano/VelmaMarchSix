...
//clicked by user.
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(mcontext)
                ...
                .setContentTitle(eventname)
                .setAutoCancel(true)
                .setContentText("You have an event in " + location + " at " + timeStart + " until " + timeEnd)
        ...
        notificationBuilder.addAction(R.drawable.ic_delete_black_24dp, "Cancel", pendingIntentCancel);
        notificationBuilder.addAction(R.drawable.ic_assignment_late_blue_500_18dp, "I'll be coming late", pendingIntentLate);
